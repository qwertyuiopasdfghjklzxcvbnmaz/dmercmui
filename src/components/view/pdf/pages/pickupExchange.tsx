...
import { initalFields, homeStateObject, initalRelationship } from './configPickupExchange';
// import $ from 'jquery';
let isPatient = true;

function PickupExchange() {
                                    ...
                                    <div className='card-body pb-0 mb-4'>
                                        <div className="row g-1">
                                            ...
                                            <div className="col-md-5">
                                                ...
                                                <input onChange={handleChange} value={fields?.serialNo} name='serialNo' type="text" className="form-control form-control-sm" id="serialNo" />
                                            </div>
